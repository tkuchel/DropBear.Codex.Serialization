...
public interface IDataSerializer
{
    ...
    /// </summary>
    Task<Result<string>> SerializeJsonAsync<T>(T data, CompressionOption compressionOption, EncodingOption encodingOption);

    /// <summary>
    /// Deserializes data from JSON format with optional compression and decoding.
    /// </summary>
    Task<Result<T>> DeserializeJsonAsync<T>(string data, CompressionOption compressionOption, EncodingOption encodingOption);
