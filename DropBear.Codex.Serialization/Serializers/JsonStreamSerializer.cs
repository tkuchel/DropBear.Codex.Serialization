...
public class JsonStreamSerializer : IStreamSerializer
{
    ...
    public async Task<T?> DeserializeAsync<T>(Stream stream, CancellationToken cancellationToken = default) =>
        await System.Text.Json.JsonSerializer.DeserializeAsync<T>(stream, _options, cancellationToken).ConfigureAwait(false) ??
        default(T);
    ...
    public async Task<byte[]> DeserializeRawBytesAsync(Stream stream, CancellationToken cancellationToken = default)
    {
